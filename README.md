...
- **MCP tool allowlist** - only approved tools are callable by AI agents. Credentials (OAuth tokens, API keys) live on the sidecar and never enter the app container

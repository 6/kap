/// Minimal DNS forwarder with domain filtering.
///
...
///
/// This is intentionally minimal — it handles standard A/AAAA queries and
/// forwards them byte-for-byte. No caching, no recursion, no DNSSEC.
use anyhow::Result;
